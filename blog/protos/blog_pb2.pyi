...
class PostSchema(_message.Message):
    ...
    def __init__(
        ...
        slug: _Optional[str] = ...,
        body: _Optional[str] = ...,
        tags: _Optional[_Iterable[_Union[TagSchema, _Mapping]]] = ...,
...
class TagSchema(_message.Message):
    ...
    slug: str
    def __init__(
        self, title: _Optional[str] = ..., slug: _Optional[str] = ...
    ) -> None: ...
...
class CommentCreateSchema(_message.Message):
    ...
    post_id: int
    def __init__(
        self, body: _Optional[str] = ..., post_id: _Optional[int] = ...
    ) -> None: ...
...
class CommentUpdateSchema(_message.Message):
    ...
    body: str
    def __init__(
        self, id: _Optional[int] = ..., body: _Optional[str] = ...
    ) -> None: ...
...
class LikeSchema(_message.Message):
    ...
    user_id: int
    def __init__(
        self, post_id: _Optional[int] = ..., user_id: _Optional[int] = ...
    ) -> None: ...
...
class GetPostsRequest(_message.Message):
    ...
    offset: int
    def __init__(
        self, limit: _Optional[int] = ..., offset: _Optional[int] = ...
    ) -> None: ...
...
class GetPostsResponse(_message.Message):
    ...
    def __init__(
        self,
        posts: _Optional[_Iterable[_Union[PostListSchema, _Mapping]]] = ...,
    ) -> None: ...
...
class GetPostBySlugResponse(_message.Message):
    ...
    post: PostSchema
    def __init__(
        self, post: _Optional[_Union[PostSchema, _Mapping]] = ...
    ) -> None: ...
...
class CreatePostRequest(_message.Message):
    ...
    def __init__(
        self, post: _Optional[_Union[PostCreateSchema, _Mapping]] = ...
    ) -> None: ...
...
class UpdatePostBySlugRequest(_message.Message):
    ...
    def __init__(
        self,
        post: _Optional[_Union[PostUpdateSchema, _Mapping]] = ...,
        post_slug: _Optional[str] = ...,
    ) -> None: ...
...
class GetTagsResponse(_message.Message):
    ...
    tags: _containers.RepeatedCompositeFieldContainer[TagSchema]
    def __init__(
        self, tags: _Optional[_Iterable[_Union[TagSchema, _Mapping]]] = ...
    ) -> None: ...
...
class GetTagBySlugResponse(_message.Message):
    ...
    def __init__(
        self,
        tag: _Optional[_Union[TagSchema, _Mapping]] = ...,
        posts: _Optional[_Iterable[_Union[PostListSchema, _Mapping]]] = ...,
    ) -> None: ...
...
class GetPostCommentsResponse(_message.Message):
    ...
    def __init__(
        self,
        comments: _Optional[_Iterable[_Union[CommentSchema, _Mapping]]] = ...,
    ) -> None: ...
...
class CreatePostCommentRequest(_message.Message):
    ...
    def __init__(
        self, comment: _Optional[_Union[CommentCreateSchema, _Mapping]] = ...
    ) -> None: ...
...
class UpdatePostCommentRequest(_message.Message):
    ...
    def __init__(
        self, comment: _Optional[_Union[CommentUpdateSchema, _Mapping]] = ...
    ) -> None: ...
...
class GetPostLikesResponse(_message.Message):
    ...
    def __init__(
        self, likes: _Optional[_Iterable[_Union[LikeSchema, _Mapping]]] = ...
    ) -> None: ...
